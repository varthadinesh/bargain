...
export default function Addnewproduct() {
  ...
  const handleSubmit = (event) => {
    ...
    alert("Product added successfully. Product will be added to store after admin approval");
            ...
            <form className="mb-4" onSubmit={handleSubmit}>
              <div className="mb-3">
                ...
                >
                  ...
                  <option value="women" selected readonly>Women</option>
              ...
              <div className="mb-3">
                ...
                >
                  ...
                  <option value="sarees" selected readonly>Sarees</option>
                </select>
              </div>
              <div className="mb-3">
                <label
                ...
                <input
                  ...
                  value="Silk Saree With Maggam Work Blouse"
                  readOnly
                  onChange={handleInput}
                  required
                />
              ...
              <div className="mb-3">
                ...
                <textarea
                  ...
                  value="https://in.ourpunarvi.com/images/thumbs/0112265_silk-saree-with-maggam-work-blouse_550.jpeg"
                  readOnly
                  onChange={handleInput}
                  required
                ></textarea>
