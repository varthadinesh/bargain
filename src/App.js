...
import Adminproductdetails from "./components/admindashboard/Adminproductdetails";
...
function App() {
  ...
  return (
    <>
      <BrowserRouter basename="bargain">
        <Scrolltotop />
        <Routes>
          {/* Login routes */}
          ...
          <Route
            ...
            element={
              <ProtectedRoute>
                {isUserLoggedIn && <Adminproductdetails/>}
              </ProtectedRoute>
            }
          ></Route>
