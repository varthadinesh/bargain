    ...
    <>
      ...
      <nav className="navbar navbar-expand-md navbar-light bg-light sticky-top">
        ...
        <div className="ms-5">
          <Link to="/">
            <img
              src="https://lh3.googleusercontent.com/proxy/zf1FIBMtYpT3oDKBYjwnfsW9c-DuiOPugXJMTuL3p2ZpYNigvIF-s_LuNH0S5X4jzzvRxRIyX6zEYX6p2JLtwjDqXeCy8ekLm5ZY7PPyEzl7xoijzrF2_eRhC13gX4v5_JFAXbr0Ov6Wh40"
              alt="logo"
              height="50px"
              width="120px"
            />
        ...
        <div className="d-md-flex">
          ...
          <div className="d-md-flex ps-2 pe-2 mt-3">
          {isLoggedIn ? (
          <>
            <div className="">
              <Link
                to="/"
                className="text-decoration-none text-dark ps-2 pe-2"
                onClick={handlelogout}
              >
                Log Out
              </Link>
